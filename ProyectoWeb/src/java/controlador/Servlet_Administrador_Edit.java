...
@WebServlet("/Servlet_Administrador_Edit")
public class Servlet_Administrador_Edit extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String tabla;
		String ruta=request.getServletContext().getRealPath("/")+"xml_login.xml";
		...
		try{
			...
			for (int i = 0; i < nodos.size() ; i++) {
				 ...
				 tabla+="<td style=\"border:1px solid black; \">"+elemento.getAttributeValue("tipo")+"</td>";
				 tabla+="<td style=\"border:1px solid black;\" hidden>"+elemento.getAttributeValue("id")+"</td>";
				 tabla+="<td style=\"border:1px solid black; \">"+"<a href=\"javascript:editarUsuario("+id+")\">"+"Editar"+"</a>"+"</td>";
				 tabla+="<td style=\"border:1px solid black; \">"+"<a href=\"javascript:eliminarUsuario("+id+")\" >"+"Eliminar"+"</a>"+"</td></tr>\n";
			}
			 tabla+="</table>";
			 out.print(tabla);
