    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (int i = 1; i <= numero; i++) {
                ...
                out.println("contexto.moveTo("+request.getParameter("xi"+i)+","+request.getParameter("yi"+i)+");");
                out.println("contexto.lineTo("+request.getParameter("xf"+i)+","+request.getParameter("yf"+i)+");");
