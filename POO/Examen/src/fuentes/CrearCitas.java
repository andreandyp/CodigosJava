...
public class CrearCitas extends Citas implements ActionListener {
    ...
    JTextField nombre, telefono, email, marca, modelo, placas;
    JLabel lnombre, ltelefono, lemail, lmarca, lmodelo, lplacas;
    JButton enviar;
    ...
    private void crearInterfaz() {
        ...
        lnombre.setBounds(0, 0, 75, 20);
        ltelefono.setBounds(0, 20, 75, 20);
        lemail.setBounds(0, 40, 75, 20);
        lmarca.setBounds(0, 80, 75, 20);
        lmodelo.setBounds(0, 100, 75, 20);
        lplacas.setBounds(0, 120, 75, 20);
