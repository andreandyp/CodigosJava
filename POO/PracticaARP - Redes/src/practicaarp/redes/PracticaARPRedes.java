...
InetAddress IPorigen=null;
    ...
    for(int k=0;k<MACo.length;k++)
      ...
      byte[]IPo =IPorigen.getAddress();
       System.out.println(IPo.length);
      for(int k=0;k<IPo.length;k++)
      a[k]=IPo[k];  //MAC origen
			...
			public void nextPacket(PcapPacket packet, String user) {
				...
				System.out.printf("Paquete recibido el %s caplen=%-4d len=%-4d %s\n",
				    ...
				    user                                 // User supplied object
                                ...
                                if(packet.hasHeader(arp) && !FormatUtils.mac(arp.tha()).equals("00:00:00:00:00:00")){
